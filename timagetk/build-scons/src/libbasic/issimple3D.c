/****************************************************
 * issimple3D.c - determine si un point 3D est simple
 *
 * $Id: issimple3D.c,v 1.2 2000/08/08 14:48:26 greg Exp $
 *
 ...
 * Feb, 24 2000
 *
 * C'est la version specialisee du calcul optimise de T06 et de T26.
 *
 *
 * ADDITIONS, CHANGES
 *
...
#if defined(_STATISTICS_)
int IsA3DPointSimple( int neighbors[27], int *TESTS_nb, int *EQUIV_nb )
#else
int IsA3DPointSimple( int neighbors[27] )
#endif
{
