 ...
 * readbmp.c
 *
 * $Id: readbmp.c,v 1.2 1999/10/06 16:26:31 greg Exp $
 *
 * AUTHOR:
 ...
 *
 * * Wed Oct  6
 *   replace rc = readINT16little(fp, &tempVal); by rc = readUINT16little(fp, &tempVal);
 *   and     rc = readINT8little(fp, &temp);     by rc = readUINT8little(fp, &temp);
 *
 */
