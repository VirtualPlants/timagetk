...
int OLD_Compute_T26( int neighbors[27] )
{
    ...
    if ( GET_VAL( neighbors, 4 ) != 0 ) {
 	if ( GET_VAL( neighbors, 10 ) != 0 ) {
		...
		label_vertex[4] = label_vertex[5] = label_vertex[6] = 0;
		label_exists[0] = label_exists[1] = label_exists[2] = label_exists[3] = _TRUE_;
		label_exists[4] = label_exists[5] = label_exists[6] =_TRUE_;
	    } else {
		label_vertex[1] = label_vertex[2] = label_vertex[3] = 0;
	    ...
	    if ( GET_VAL( neighbors, 12 ) != 0 ) {
		label_vertex[1] = label_vertex[2] = label_vertex[3] = 0;
		label_vertex[4] = label_vertex[6] = 0;
		label_exists[0] = label_exists[1] = label_exists[2] = label_exists[3] = _TRUE_;
	...
	if ( GET_VAL( neighbors, 10 ) != 0 ) {
	    if ( GET_VAL( neighbors, 12 ) != 0 ) {
		label_vertex[1] = label_vertex[2] = 0;
		label_vertex[4] = label_vertex[5] = label_vertex[6] = 0;
		label_exists[0] = label_exists[1] = label_exists[2] = _TRUE_;
		label_exists[4] = label_exists[5] = label_exists[6] =_TRUE_;
	    } else {
    ...
    /*--- Let consider component #5 and its possible equivalences:

          we will examinate the possible points of #5 which
	  may generate an equivalence with an other component:
	  - 1 points (23) yields an equivalence between
	    two components
    ---*/
    ...
    /*--- Let consider component #6 and its possible equivalences:

          we will examinate the possible points of #6 which
	  may generate an equivalence with an other component:
	  - 1 points (25) yields an equivalence between
	    two components
    ---*/
