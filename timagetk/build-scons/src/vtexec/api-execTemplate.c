...
int API_execTemplate( vt_image *image, vt_image *imres, char *param_str_1, char *param_str_2 )
{
                                  ...
                                  lineCmdParamExecTemplate *p )
{
          ...
          if ( argv[i][1] == '\0' ) {
            if ( inputisread == 0 ) {
              if ( p->allow_stdin_stdout ) {
                ...
                API_ErrorParse_execTemplate( (char*)NULL, "parsing '-', stdin is not allowed\n", 0 );
              }
            }
              ...
              if ( p->allow_stdin_stdout ) {
                ...
                API_ErrorParse_execTemplate( (char*)NULL, "parsing '-', stdout is not allowed\n", 0 );
              }
            }
            else {
  ...
  if ( inputisread == 0 ) {
    if ( p->allow_stdin_stdout ) {
      ...
      API_ErrorParse_execTemplate( (char*)NULL, "no input file ...\n", 0 );
    }
  }
  if ( outputisread == 0 ) {
    if ( p->allow_stdin_stdout ) {
      ...
      API_ErrorParse_execTemplate( (char*)NULL, "no output file ...\n", 0 );
    }
  }
