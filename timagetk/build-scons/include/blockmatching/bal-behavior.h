...
#define _ORIGINAL_BALADIN_FLOAT_VOXEL_SIZE_ 
/* I remove this one, _ORIGINAL_BALADIN_BLOCKS_MANAGEMENT_
 * since it causes all the blocks to be removed when
 * the z size of blocks is equal to the z dimension
 * of images
 * GM, Mar 27 oct 2015 09:09:53 CET
 */
/* #define _ORIGINAL_BALADIN_BLOCKS_MANAGEMENT_ */
#define _ORIGINAL_BALADIN_TOLERANCE_IN_LTS_ 
#define _ORIGINAL_BALADIN_ERROR_RETURN_IN_LTS_ 
