...
extern void setVerboseInRecBuffer( int v );
extern void incrementVerboseInRecBuffer(  );
extern void decrementVerboseInRecBuffer(  );
...
extern int GradientModulus( void *bufferIn, bufferType typeIn,
			    ...
			    float *filterCoefs, filterType filterType );
...
extern int RecursiveFilterOnBuffer( void *bufferIn, /* input buffer */
				    ...
				    filterType filterType /* type of the recursive filter to be applied */
				    );
