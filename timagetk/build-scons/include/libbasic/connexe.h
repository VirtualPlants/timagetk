 ...
 *
 * DESCRIPTION:
 * The connected components are sorted by decreasing size
 ...
 * will be equal to the number of connected components
 *
 * RETURN:
 *  1: success
 * -1: error
 ...
 */
extern void setVerboseInConnexe( int v );
extern void incrementVerboseInConnexe(  );
 ...
 */
extern void decrementVerboseInConnexe(  );
